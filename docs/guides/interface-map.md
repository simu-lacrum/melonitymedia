...
| **Вкладка: Прогрев** | Настройка и мониторинг batch-прогрева для выбранных аккаунтов. Дни, ротация IP, хештеги. **Авто-продолжение**: после запуска все дни выполняются автоматически в multi-session режиме |
