...
| Блок | Контент |
|------|---------|
| KPI Cards (×4) | Просмотры, Живые аккаунты, Подписчики, Видео (данные из БД, обновляются cron каждые 6ч) |
...
| **Вкладка: Прогрев** | Настройка и мониторинг batch-прогрева для выбранных аккаунтов. Дни, ротация IP, хештеги. **Авто-продолжение**: после запуска все 10 дней выполняются автоматически (self-rescheduling 20-28ч) |
